...
import com.prashant.musicvideosample.adapter.ViewPager2Adapter
import com.prashant.musicvideosample.databinding.FragmentHomeBinding
import com.prashant.musicvideosample.model.VideosModel
import com.prashant.musicvideosample.utils.Constants
import com.prashant.musicvideosample.utils.PreCachingService
...
class HomeFragment : Fragment(),KodeinAware {
    ...
    private fun loadNewVideosIfNeeded(){
        videosViewModel.shouldFetchNewVideos?.observe(viewLifecycleOwner,{
            it?.let {
                if (it){
